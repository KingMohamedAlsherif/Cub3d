...
static void	file_len(t_game *cub, char *input_file);
static void	file_create(t_game *cub, t_file *file, char *input_file);
static void	map_create(t_game *cub, t_map *map, int st, int end);
static void	map_validate(t_game *cub, t_map *map, char **map_arr, char invalid);

void	parsing(t_game *cub, char *input_file)
{
	t_file	*file;
	t_map	*map;
	int		len;
...
/*
	*	parsing(t_game *cub, char *input_file)
	{
	...
	*	file_len(t_game *cub, char *input_file)
	{
	...
	*	file_create(t_game *cub, t_file *file, char *input_file));
	{
	...
	*	file_validate(t_game *cub, t_file *file, t_map *map);
	{
	...
	*	map_create(t_game *cub, t_file *file, t_map *map);
	{
		-	create the map
	...
	*	map_validate(t_game *cub, t_map *map, char **map_arr, char invalid);
	{
		-	validate the map
