...
static void	validate_img(t_game *cub, t_txtdata *txtr, char *line);
static void	validate_color(t_game *cub, int *arr, int *value, char *line);
static void	validate_elements(t_game *cub, char *line);
static void	validate_map(t_game *cub, t_file *file, t_map *map, int st);

void	file_validate(t_game *cub, t_file *file, t_map *map)
{
	char	**file_arr;
	int		i;
...
/*
	*	file_validate(t_game *cub, t_file *file)
	{
	...
	*	validate_elements(t_game *cub, t_file *file, char *line)
	{
	...
	*	validate_img(t_game *cub, t_txtdata *txtr, void **img, char *line)
	{
	...
	*	validate_color(t_game *cub, int *arr, char *line)
	{
	...
	*	validate_map(t_game *cub, t_file *file, int st)
	{
