...
/*   Updated: 2025/05/24 13:41:08 by malsheri         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	is_parsing(t_cub *game, char *file, t_game *cub)
{
	...
	assign_map(game, map_lines, line_count, cub);
	...
	parse_rgb(game, game->c_rgb, &game->colors, 0);
	parse_rgb(game, game->f_rgb, &game->colors, 1);
}
